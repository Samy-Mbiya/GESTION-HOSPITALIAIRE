...
from .views import registerClient, editteClient, supprimerClient, recherche, \
    listFac, listHon, add_description, add_description_nh, updateFac, deleteFac, update_Description, \
    deleteDesc, updateNh
...
urlpatterns=[
    ...
    #Facture
    path('list_fac/<int:client_id>/',listFac,name='list_Fac'),#Liste et enregistrement de la  Facture et la Note H par client
    ...
    path('edit_hon/<int:honoraire_id>/', updateNh, name='edit_Hon'),  # Modification Honoraire
    ...
    #Description Note d'Honoraire
    path('description_Hon/<int:honoraire_id>',add_description_nh, name='add_description_nh'),#Description Facture
    ]